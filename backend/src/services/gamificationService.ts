...
export async function seedAchievements(): Promise<void> {
  ...
  const defaultAchievements = [
    { name: '首次签到', description: '完成每日签到', category: AchievementCategory.STREAK, condition_type: 'check_in_count', condition_value: 1, xp_reward: 20, icon: '📅' },
    { name: '连续7天', description: '连续签到7天', category: AchievementCategory.STREAK, condition_type: 'streak_days', condition_value: 7, xp_reward: 100, icon: '🔥' },
    { name: '连续30天', description: '连续签到30天', category: AchievementCategory.STREAK, condition_type: 'streak_days', condition_value: 30, xp_reward: 500, icon: '⚡' },
    { name: '练习新手', description: '完成10次练习', category: AchievementCategory.PRACTICE, condition_type: 'practice_count', condition_value: 10, xp_reward: 50, icon: '🎯' },
    { name: '练习达人', description: '完成100次练习', category: AchievementCategory.PRACTICE, condition_type: 'practice_count', condition_value: 100, xp_reward: 200, icon: '🏆' },
    { name: '课程完成者', description: '完成第一个课程', category: AchievementCategory.COURSE, condition_type: 'courses_completed', condition_value: 1, xp_reward: 150, icon: '📚' },
    { name: '学习探险家', description: '学习3种不同场景', category: AchievementCategory.EXPLORATION, condition_type: 'scenes_explored', condition_value: 3, xp_reward: 75, icon: '🗺️' },
    { name: '语言大师', description: '达到30级', category: AchievementCategory.PRACTICE, condition_type: 'level', condition_value: 30, xp_reward: 1000, icon: '👑' }
  ];
