...
Learning goals allow users to define and track their language learning objectives over time. Users can set short, manage, and track progress toward goals with personalized learning objectives.
